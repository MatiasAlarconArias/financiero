...
const FALLBACK_TRENDS: Record<string, number[]> = {
  ...
  MX: [2.6, 2.1, 2.2, -0.2, -8.6, 5.7, 3.9, 3.3, 1.5],
...
export default async function Home() {
  ...
  return <><Navbar /><EconomicHero countries={countries} dataYear={DATA_YEAR} /><EconomicIndicators countries={countries} dataYear={DATA_YEAR} /><CountryComparator countries={countries} dataYear={DATA_YEAR} /></>;
}
