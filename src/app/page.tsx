...
import IndicatorLearning from "@/components/IndicatorLearning";
...
export default async function Home() {
  ...
  return <><Navbar /><EconomicHero countries={countries} dataYear={DATA_YEAR} /><EconomicIndicators countries={countries} dataYear={DATA_YEAR} /><CountryComparator countries={countries} dataYear={DATA_YEAR} /><HistoricalChart countries={countries} dataYear={DATA_YEAR} /><RegionalRankings countries={countries} dataYear={DATA_YEAR} /><CountryProfile countries={countries} dataYear={DATA_YEAR} /><IndicatorLearning /><DataSourcesFooter dataYear={DATA_YEAR} /></>;
}
